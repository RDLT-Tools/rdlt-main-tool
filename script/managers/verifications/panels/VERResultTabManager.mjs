...
export default class VERResultTabManager {
    ...
    #initializeView() {
        ...
        this.#view.violatingVertices.section = this.#rootElement.querySelector(`[data-ver-section="v-vertices"]`);
        this.#view.violatingVertices.table = this.#rootElement.querySelector(`[data-ver-section="v-vertices"] table`);
        this.#view.violatingArcs.section = this.#rootElement.querySelector(`[data-ver-section="v-arcs"]`);
        this.#view.violatingArcs.table = this.#rootElement.querySelector(`[data-ver-section="v-arcs"] table`);
    }
    ...
    displayInstanceResult(instance) {
        ...
        if(criteria && criteria.length > 0) {
            ...
            for(const criterion of criteria) {
                const criteriaRow = buildElement("tr", { classname: "criteria-row" }, [
                    buildElement("td", {}, [ buildElement("i", { classname: "fas fa-" + (criterion.pass ? "check" : "close")}) ]),
        ...
        const violatingArcsTableBody = this.#view.violatingArcs.table.querySelector("tbody");
        ...
        const violatingVerticesTableBody = this.#view.violatingVertices.table.querySelector("tbody");
