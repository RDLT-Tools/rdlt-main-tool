 ...
 */
function parseNextNumber(line, startIndex) {
 ...
 */
function parseNextBoolean(line, startIndex) {
 ...
 */
function parseNextString(line, startIndex) {
    startIndex = skipToNonWhitespace(line, startIndex);
 ...
 */
function parseNextPoint(line, startIndex) {
    startIndex = skipToNonWhitespace(line, startIndex);
    if(startIndex >= line.length) return { value: null, nextIndex: startIndex };
 ...
 */
function parseNextNamedArg(line, startIndex) {
    startIndex = skipToNonWhitespace(line, startIndex);
    if(startIndex >= line.length) return { value: null, nextIndex: startIndex };
 ...
 */
function parseNextNamedArgList(line, startIndex) {
    startIndex = skipToNonWhitespace(line, startIndex);
 ...
 */
function parseNextList(line, startIndex) {
    startIndex = skipToNonWhitespace(line, startIndex);
    if(startIndex >= line.length) return { name: null, values: [], nextIndex: startIndex };
 ...
 */
function parseNextPointsList(line, startIndex) {
    startIndex = skipToNonWhitespace(line, startIndex);
    if(startIndex >= line.length) return { name: null, values: [], nextIndex: startIndex };
 ...
 * @return {{ values: string[], nextIndex: number }}
 */
function parseNextOrderedArgs(line, count, startIndex) {
    startIndex = skipToNonWhitespace(line, startIndex);
 ...
 * @return {{ value: number[], nextIndex: number }}
 */
function parseNextRange(line, startIndex) {
    startIndex = skipToNonWhitespace(line, startIndex);
...
function skipToNonWhitespace(line, startIndex) {
    return skipToNeither(line, [" ", "\t", "\r"], startIndex);
}

function skipToEither(line, chars, startIndex) {
    while(startIndex < line.length) {
...
function skipToNeither(line, chars, startIndex) {
    while(startIndex < line.length) {
        if(!chars.includes(line[startIndex])) return startIndex;
        startIndex++;
    }
...
function skipToChar(line, char, startIndex) {
    return skipToEither(line, [char], startIndex);
}

function skipToWhitespace(line, startIndex) {
    return skipToEither(line, [" ", "\t", "\r"], startIndex);
}

function skipToNonNumeric(line, startIndex) {
